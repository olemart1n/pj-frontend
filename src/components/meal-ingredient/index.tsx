...
export const MealIngredient = component$<IngredientObj>(({ props }) => {
  ...
  return (
    ...
    >
        ...
        <div class="relative flex">
          <label class="relative flex w-full cursor-pointer items-center justify-center">
            ...
            >
              <div
                class={
                  "dot absolute left-0 h-4 w-4 rounded-full border bg-white transition duration-500 " +
      ...
      <div class="border-t-1 flex w-2/3 justify-around">
        {props.is_fresh_ingredient && <div class="bg-amber-200">ferskvare</div>}
